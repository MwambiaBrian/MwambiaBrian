...
4. [Real Estate Application]([Link to project]([https://github.com/MwambiaBrian/chat-mern-app](https://github.com/MwambiaBrian/Real-estate)))
5. - This is a full-stack real estate application built with the MERN stack (MongoDB, Express.js, React, Node.js).
 ...
 6. [Client & Project Manager App]([Link to project](https://github.com/MwambiaBrian/project-mgmt-app))
